<template>
    ...
    <section class="flex items-center justify-center py-16 bg-gray-100 min-w-screen tails-selected-element dark:bg-gray-900" id="Testimonials">
    <div class="max-w-6xl px-12 mx-auto bg-gray-100 md:px-16 xl:px-10 dark:bg-gray-900">
        <div class="flex flex-col items-center lg:flex-row">
            <div class="flex flex-col items-start justify-center w-full h-full pr-8 mb-10 lg:mb-0 lg:w-1/2">
                ...
                <h2 class="text-4xl font-extrabold leading-10 tracking-tight text-gray-900 dark:text-white sm:text-5xl sm:leading-none md:text-6xl lg:text-5xl xl:text-6xl">Testimonials</h2>
            ...
            <div class="w-full lg:w-1/2">
                <blockquote class="flex items-center justify-between w-full col-span-1 p-6 bg-white rounded-lg shadow dark:bg-gray-800" data-rounded="rounded-lg" data-rounded-max="rounded-full">
