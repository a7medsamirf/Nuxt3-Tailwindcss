<template>
  <section class="py-12 sm:py-16 bg-white tails-selected-element" id="our-service">
    <div class="max-w-7xl px-10 mx-auto sm:text-center">
        <p class="text-bubble-gum font-medium">our service</p>
        <h2 class="font-bold text-3xl sm:text-4xl lg:text-5xl mt-3">Determine the service you need</h2>
